...
// Persists the nav scroll position across remounts caused by page navigation
...
const DashboardLayout: React.FC<DashboardLayoutProps> = ({ children }) => {
  ...
  // Restore nav scroll so it only moves when the user scrolls it
  useEffect(() => {
    ...
    <div className="min-h-screen bg-background dark:bg-transparent">
          ...
          <div className="flex items-center gap-3">
            ...
            <DropdownMenu>
              <DropdownMenuTrigger asChild>
                <Button
                  variant="ghost"
                  className="flex items-center gap-2.5 px-3 rounded-xl hover:bg-muted"
                >
      ...
      >
        ...
        <div className="flex-shrink-0 p-4 border-t border-border/50">
          <div className="p-4 rounded-xl bg-muted/50 border border-border/50 dark:border-[rgba(255,255,255,0.10)]">
            ...
            <p className="text-[10px] text-muted-foreground">
              All monitors connected
            </p>
            <div className="flex items-center gap-1.5 mt-2">
              {[1, 2, 3, 4].map((i) => (
                <div
                  key={i}
                  className="w-2 h-2 rounded-full bg-status-normal animate-pulse"
