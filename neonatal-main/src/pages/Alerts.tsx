...
const Alerts = () => {
  ...
  const [filter, setFilter] = useState<"all" | "critical" | "high" | "normal">(
    "all",
  );
  ...
  const highCount = unacknowledgedAlerts.filter(
    (a) => a.level === "high",
  ).length;
  const normalCount = unacknowledgedAlerts.filter(
    (a) => a.level === "normal",
  ).length;
        ...
        <Card className="card-medical">
          ...
          <CardContent>
            <div className="grid md:grid-cols-3 gap-4">
              <div className="p-4 rounded-lg bg-status-normal-bg border border-status-normal/55 dark:shadow-[0_0_0_1px_rgba(0,255,136,0.25),0_0_18px_rgba(0,255,136,0.14)]">
                <Badge variant="normal" className="mb-2">
                  Level 0
                </Badge>
              ...
              <div className="p-4 rounded-lg bg-status-warning-bg border border-status-warning/55 dark:shadow-[0_0_0_1px_rgba(255,170,0,0.25),0_0_18px_rgba(255,170,0,0.14)]">
              ...
              <div className="p-4 rounded-lg bg-status-critical-bg border border-status-critical/55 dark:shadow-[0_0_0_1px_rgba(255,0,60,0.25),0_0_18px_rgba(255,0,60,0.14)]">
