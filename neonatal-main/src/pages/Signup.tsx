  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (result.success) {
      toast({
        ...
        description:
          "Your account has been created successfully. Please check your email if verification is required.",
      });
      ...
      <div className="hidden lg:flex lg:w-1/2 gradient-primary relative overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col justify-center px-16 text-primary-foreground">
          ...
          <p className="text-lg text-primary-foreground/80 mb-12 max-w-md">
            Register to access the neonatal monitoring system. Help protect our
            most precious patients with cutting-edge technology.
          </p>
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-sm text-primary-foreground/70">
                  Continuous monitoring of heart rate, SpO₂, temperature, and
                  movement
                </p>
              </div>
            </div>
                ...
                <div className="space-y-2">
                  ...
                  >
                    ...
                    <SelectContent>
                      ...
                      <SelectItem value="senior_doctor">
                        Senior Doctor
                      </SelectItem>
                    </SelectContent>
                  </Select>
